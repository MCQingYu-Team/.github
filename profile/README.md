...
清屿是一台面向 **生电（技术向生存）** 的 Minecraft 服务器，玩法以红石机械、自动化装置与大型工程为主，开放 **Java 版**与**基岩版**入口（共用同一套世界），主服之外另有**与主服同种子**的测试服用于施工前验证机器与红石设计，两台服务器均提供网页地图；服务器于 **2026 年 9 月 20 日**从 ChenRay 独立成立，规则、运营与封禁体系自此由清屿自行制定与执行。
